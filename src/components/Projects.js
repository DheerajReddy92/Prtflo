...
const Projects = () => {
    return (
    <div className="sect sect--white projects">
      <div className="container">
        ...
        <div className="projects-grid"> {/* Changed to grid container */}
          <div data-aos="fade-up" data-aos-duration="1500" className="card card-color-0">
          ...
          <div data-aos="fade" data-aos-duration="1500" className="card card-color-1">
            <div style={{opacity:'0.7'}} className="border"></div>
            <img data-aos="zoom-out" style={{opacity:'0.7'}} data-aos-duration="1500" className='projectimg' src={process.env.PUBLIC_URL + '/Images/driveassist.gif'} alt="project" />
            <h1 data-aos="fade-right" data-aos-duration="1500" className='projname'>Drive Assist</h1>
          </div>
     
          <div data-aos="fade" data-aos-duration="1500" className="card card-color-2">
            <div style={{opacity:'0.7'}} className="border"></div>
          ...
          <div data-aos="fade-left" data-aos-duration="1500" className="card card-color-3">
            <div style={{opacity:'0.7'}} className="border"></div>
            <img style={{opacity:'0.7'}} data-aos="zoom-out" data-aos-duration="1500" className='projectimg' src='https://cdn.dribbble.com/users/997070/screenshots/4120967/attachments/943230/01-1._Cover_Copy_2x.png' alt="project" />
